...
# ─────────────────────────────────────────────────────────────────
    ...
    ramas_x_default = float(ramas_x_default)
    ramas_y_default = float(ramas_y_default)
...
# ── CAMBIO AÑADIDO: radio button para pérdida de recubrimiento ───
# Ubicación: sidebar, antes del botón Calcular.
# Conecta con el parámetro `spalling` de calcular_momento_curvatura.
